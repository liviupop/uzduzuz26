...
A commitment of this size requires the discipline to test it constantly against evidence. That is not a paradox; it is the next principle. Pro-European does not mean uncritical, and the kind of thinking we mean is the next one in this list.
